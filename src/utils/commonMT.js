...
class commonMT extends Base {
  ...
  loadPriceFont(){
    wx.loadFontFace({
      family: 'priceFont',
      source: 'url("https://api.czsjcrm.cn/font/terminaldosismedium.ttf")',
    ...
    wx.loadFontFace({
      family: 'priceFont',
      source: 'url("http://applet.czsjcrm.cn/images/xcx/terminaldosismedium.woff")',
      success: function(res) {
        console.log(res.status) //  loaded
      },
      fail: function(res) {
  ...
  // 时间格式化输出，如11:03 25:19
  _dateformat(micro_second) {
    // 总秒数
